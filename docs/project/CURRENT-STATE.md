...
-   PostgreSQL 17 via Docker Compose; versioned SQL migrations with
    checksum verification (ADR-0008), `0001` to `0024`. Tables: Better
    ...
    `debt_payment`, `goal`, `goal_progress`; view
...
SDD-045 to SDD-049). SDD-045 to SDD-047 implemented.
...
Implement SDD-048 (in-app reminders). Owner decision
