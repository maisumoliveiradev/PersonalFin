...
v0.4.0: SDD-023 and SDD-024 implemented.
...
-   **Cards (SDD-023):** cards with name, closing and due days, and an
    append-only limit history with effective dates (DR-079); archive and
    reactivate.
-   **Card purchases and invoices (SDD-024):** expenses paid with a card
    ...
    includes card purchases. There are no installments, payments, or
    used/available limit yet.
...
`docs/sdds/v0.4.0/SDD-025-installment-purchases.md`. Domain decisions
