...
-   **Card purchases (DR-035, DR-079):** belong to period `M` when their
    ...
    are Forecast until their invoice is paid (payments arrive in
    SDD-026). They enter M-008 only through their invoices.
...
| M-008 | Saldo projetado (fim do mês) | Let B be M-007 (observed on date d). M-008 = B + Σ(income − expense) of transactions other than card purchases dated after d and before the end of M (any status) + Σ(income − expense) of such Pending transactions dated on or before d − Σ open amount of card invoices due before the end of M | A calculation, never an observed value (DR-025, DR-028). Paid transactions dated on or before d are assumed to be reflected in B. Card purchases move cash only through their invoice. Null when M-007 is null. |
